...
# MAGIC
# MAGIC <img src="https://files.training.databricks.com/images/icon_note_32.png" alt="Note"> この例ではPython 3.5で導入された <a href="https://docs.python.org/3/library/typing.html" target="_blank">Pythonタイプヒント</a>を使います. この例では型ヒントは必須ではありませんが、代わりに、開発者が関数を正しく使用するのに役立つ "ドキュメント" として機能します。 この例では、UDF が一度に 1 つのレコードを処理し、単一の **`str`** 引数を取り、 **`str`** 値を返すことを強調するために使用されています。

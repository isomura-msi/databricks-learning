...
# MAGIC * バージョン:  **jp-v3.1.2_2**
# MAGIC * 和訳日: **May 29, 2023 at 03:11:06 UTC**
# MAGIC     * jp-v3.1.2_2: 日本語誤りを修正 **Feb 15, 2024 at 10:09:00 UTC**
# MAGIC     * jp-v3.1.2_1: DE 6 のみ v3.1.11 に更新 **Jan 18, 2024 at 06:35:00 UTC**
...
# MAGIC %md
# MAGIC ## 著作権 (Copyrights)
# MAGIC このセクションでは、このコースで使用されるデータセットに関連するさまざまな著作権について説明します。
# MAGIC
